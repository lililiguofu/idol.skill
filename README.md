...
3. **人设补强（建议主动多问）**：MBTI、血型/星座、动物塑、口癖、希望强调气质、专属称呼（均可跳过，但默认会问一嘴）。  
4. **Step 2（导入物料）**：A Bubble、B Weverse、C 采访、D 社媒转写、E 脑内记忆。
...
| `meta.json` | `schema_version`、`updated_at`、`itinerary_status`、`corpus_weights`、`current_mood`、`warnings` 等 |
